...
class inv_kin_node : public rclcpp::Node
{
public:
    inv_kin_node() : Node("inv_kin_node")
    {
        ...
        // Call the IK solver
        alglib::real_1d_array joint_angles = solve_Ik(x_ee_pos, y_ee_pos, z_ee_pos);
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<inv_kin_node>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
